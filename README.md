...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/string-right-trim-n/tags). For example,

```javascript
rtrimN = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-right-trim-n@v0.2.3-umd/browser.js' )
```
...
[@stdlib/string/left-trim-n]: https://github.com/stdlib-js/string-left-trim-n/tree/umd
